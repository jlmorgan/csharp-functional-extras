...
namespace FunctionalExtras.Data
{
  ...
  public static class Maybe
  {
    ...
    /// <typeparam name="V">The underlying type parameter.</typeparam>
    ...
    /// result.</param>
    /// <param name="list">The <code>list</code> of values.</param>
    /// <typeparam name="V">The underlying type parameter of the <code>list</code>.</typeparam>
    /// <typeparam name="R">The underlying type parameter of the result <code>list</code>.</typeparam>
    ...
    /// <param name="maybe">The <see cref="Maybe"/>.</param>
    /// <typeparam name="V">The underlying type parameter of the <code>maybeMap</code>.</typeparam>
    /// <typeparam name="R">The default and return type parameter.</typeparam>
    /// <exception cref="ArgumentNullException">if the <code>morphism</code> is <code>null</code>.</exception>
